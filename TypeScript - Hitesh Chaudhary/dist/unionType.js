...
// Union in arrays
let arr1 = [1, 4, 5]; //  Valid untill all values are numbers.
let arr2 = ["raj", "abhi", "amit"]; //  Valid untill all values are strings.
let arr3 = [1, 23, 456, 7890]; //  Either all values can be number or all values can be string.
...
let arr4 = [1, true, true, false, 0, 1];
